...
class _$CompanyModelImpl implements _CompanyModel {
  const _$CompanyModelImpl({required this.company});
  ...
  @override
  String toString() {
    return 'CompanyModel(company: $company)';
  }
...
abstract class _CompanyModel implements CompanyModel {
  const factory _CompanyModel({required final Company company}) =
      _$CompanyModelImpl;
...
abstract class _Company implements Company {
  ...
  @override // @JsonKey(name: 'is_active')
  int get isActive;
  @override
  String get name;
  @override
